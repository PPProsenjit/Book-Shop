...
import banner from '../../../assets/images/Others/bg-banner2.jpg'


const Banner = () => {
    return (
        <section  className='lg:h-[600px]'>
            <div style={{ background:`url(${banner})`}} className="bg-auto bg-no-repeat ">
                <div className="flex justify-center text-center items-center lg:py-40 lg:px-80">
